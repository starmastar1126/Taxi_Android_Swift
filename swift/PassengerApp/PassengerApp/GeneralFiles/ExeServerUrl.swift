...
//        let urlStr : NSString = (url as NSString).addingPercentEscapes(using: String.Encoding.utf8.rawValue)! as NSString
        
//         let request = NSMutableURLRequest(url: NSURL(string: urlStr as String)! as URL)
