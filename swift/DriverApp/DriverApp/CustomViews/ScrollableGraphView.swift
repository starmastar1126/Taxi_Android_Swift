...
@objc open class ScrollableGraphView: UIScrollView, UIScrollViewDelegate, ScrollableGraphViewDrawingDelegate {
    ...
    @IBInspectable open var dataPointBorderColor: CGColor = UIColor.clear.cgColor
    
    @IBInspectable open var dataPointBorderWidth: CGFloat = 0
...
//            dataPointLayer?.borderColor = dataPointBorderColor
//            dataPointLayer?.borderWidth = dataPointBorderWidth
