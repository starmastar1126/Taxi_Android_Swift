...
public class TimeFragment extends Fragment {
    ...
    /**
     * Create and return the rider interface view for this fragment.
     */
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // the rider toggles the AM/PM button. Only applies to 4.0.0 and 4.0.3.
     ...
     * is not invoked when the rider toggles between AM/PM. But we need to be able
     * to detect this in order to dynamically update the tab title properly when
     * the rider toggles between AM/PM.
     * <p>
    ...
    /**
     * Used to communicate back to the parent fragment as the rider
