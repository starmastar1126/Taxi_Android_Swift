 ...
 * of useful operations and state tracking for allowing a rider to drag and reposition
...
public class ViewDragHelper {
     ...
     * of rider input or simulated rider input.
     */
    ...
    /**
     * @return The minimum distance in pixels that the rider must travel to initiate a drag
     */
    ...
    public static abstract class Callback {
         ...
         * by the rider while no child view is currently captured.
         *
        ...
        /**
         * Called when the rider has started a deliberate drag away from one
        ...
        /**
         * Called when the rider's input indicates that they want to capture the given child view
         * with the pointer indicated by pointerId. The callback should return true if the rider
         ...
         *
         * @param child     Child the rider is attempting to capture
