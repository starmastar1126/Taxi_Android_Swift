...
//                                driverArrivedActivity.setTimetext(String.format("%.2f", (float) distance_final) + "", time);
                                driverArrivedActivity.setTimetext(generalFunctions.formatUpto2Digit(distance_final) + "", time);
...
//                                activeTripActivity.setTimetext(String.format("%.2f", (float) distance_final) + "", time);
                                activeTripActivity.setTimetext(generalFunctions.formatUpto2Digit(distance_final) + "", time);
                            }
                        }
